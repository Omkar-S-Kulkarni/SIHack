  ...
  return (
    <div className="official-dashboard">
      ...
      <div className="citizen">
        ...
        <div className="frame-6"><div className="text-wrapper-8">Name of Area</div></div>
        <div className="frame-7"><div className="text-wrapper-9">Type</div></div>
        <div className="frame-8"><div className="text-wrapper-10">Land Size</div></div>
        <div className="frame-9"><div className="text-wrapper-11">Population</div></div>
        <div className="frame-10"><div className="text-wrapper-12">Communities</div></div>
        <div className="frame-11"><div className="text-wrapper-11">Pincode</div></div>
        ...
        <div className="frame-17"><div className="text-wrapper-18">Village/Taluka/District</div></div>
        <div className="frame-18"><div className="text-wrapper-19">Land Size</div></div>
        <div className="frame-19"><div className="text-wrapper-20">Population</div></div>
        <div className="frame-20"><div className="text-wrapper-21">Total no. of communities</div></div>
        <div className="frame-21"><div className="text-wrapper-22">Pincode</div></div>
